...
- The `v0.1.0` release remains a pre-release until the release-evidence PR is merged and its CI workflow passes.
- CI run history and publish artifacts provide verifiable build/test evidence for the release commit.
...
- Cloud deployment, production monitoring, distributed storage, payment, and quota management are out of scope for `v0.1.0`.
